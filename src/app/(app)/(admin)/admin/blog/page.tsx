...
export default function AdminBlogPage() {
  ...
  } = api.admin.content.listAllBlogPosts.useQuery({
    page: currentPage,
    limit: 12,
  ...
  const createBlogPostMutation =
    api.admin.content.createBlogPost.useMutation({
      onSuccess: () => {
        utils.admin.content.listAllBlogPosts.invalidate();
  ...
  const updateBlogPostMutation =
    api.admin.content.updateBlogPost.useMutation({
      onSuccess: () => {
        utils.admin.content.listAllBlogPosts.invalidate();
  ...
  const deleteBlogPostMutation =
    api.admin.content.deleteBlogPost.useMutation({
      onSuccess: () => {
        utils.admin.content.listAllBlogPosts.invalidate();
